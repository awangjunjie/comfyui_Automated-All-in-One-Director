...
TASK_DESCRIPTIONS = {
    ...
    MiniMaxH3Task.NOVEL: "Novel short-drama chapters — per-shot refs via ReferenceToVideo (r2v pipeline)",
    MiniMaxH3Task.FILM: "Film mode chapters — cinematic pacing; same chapter pipeline, separate task",
